...
module potados #(
    ...
    logic fetched_instruction_accepted;
    ...
    // Halt control signals generated by the execute stage.
    logic halt;
    // Halt acknowledgement from the program memory
    logic halted;
    ...
    potados_program_memory #(
        ...
        .instruction_accepted(fetched_instruction_accepted),
    ...
    // The next PC is the current PC plus 1 for short instructions, or plus 2 for long instructions.
    ...
    always_comb begin
        ...
        if (fetched_instruction_valid && !halt) begin
            if (decoded_instruction.is_long && decoded_instruction.partialy_decoded) begin
                ...
                fetched_instruction_accepted = 1'b1;
            end
        end
    end
